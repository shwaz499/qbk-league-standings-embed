(() => {
  ...
  const seasonId = allowSeasonOverride ? params.get("season_id") || "112" : "112";
  const seasonLabelOverride = allowSeasonOverride ? params.get("season_label") || "2026 Fall Leagues" : "2026 Fall Leagues";
