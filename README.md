...
Live QBK Fall Leagues standings widget, built for local testing first and Wix embedding second.
...
- `season_id=112`
- `season_label=2026 Fall Leagues`
- `hide_sunday=1`
- `dedupe=1`
...
```text
http://localhost:8012/widget.html?season_id=112&season_label=2026%20Fall%20Leagues&hide_sunday=1&dedupe=1
```
...
```html
<iframe
  src="https://YOUR-DOMAIN/widget.html?season_id=112&season_label=2026%20Fall%20Leagues&hide_sunday=1&dedupe=1"
